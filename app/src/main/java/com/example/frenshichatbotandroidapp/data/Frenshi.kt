...
/**!
 * A class implementing FrenShi chatbot
 */
//46, 18
class FrenShi(
        ...
        private val database: FrenShiDatabase
                ...
                private val tags : List<String> = if(versionFrenShi == "EN"){
                        ...
                        listOf("APL FR",
                                ...
                                "Apply for health insurance card FR",
                                ...
                                "Student with sufficient financial resources FR",
                                "Supplementary health insurance FR",
                                "Supporting documents APL FR",
                                "Supporting documents Financial resources FR",
